...
public:
	...
	void SetToneMapper(const TONEMAPPER ToneMapper) { m_ToneMapper = ToneMapper; Create(); }

	GLARETYPE GetGlareType(void) const { return m_GlareType; }
	void SetGlareType(const GLARETYPE GlareType) { m_GlareType = GlareType; Create(); }
	...
	void SetGlarePasses(const float Passes) { m_GlarePasses = Passes; Create(); }

	STARTYPE GetStarType(void) const { return m_StarType; }
	void SetStarType(const STARTYPE StarType) {	m_StarType = StarType; Create(); }
	...
	void SetStarPasses(const float Passes) { m_StarPasses = Passes; Create(); }

	bool GetAutoKeying(void) const { return m_AutoKeying; }
	void SetAutoKeying(const bool AutoKeying) {	m_AutoKeying = AutoKeying; Create(); }

	bool GetLumAdaption(void) const { return m_LumAdaption; }
	void SetLumAdapdation(bool LumAdaptation) {	m_LumAdaption = LumAdaptation; Create(); }
	...
	void DebugRendertarget(const int rt){if(rt != m_DebugRendertarget) { m_DebugRendertarget = rt; Create(); }}
