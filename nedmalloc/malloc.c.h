// NOTE: This is NOT the official nedmalloc!
// Some modifications made to fit the glacier2 project.
...
#define ensure_initialization() (void)(g_dl::mparams.magic != 0 || g_dl::init_mparams())
...
#define MLOCK_T               struct g_dl::win32_mlock_t
#define CURRENT_THREAD        ((long)GetCurrentThreadId())
#define INITIAL_LOCK(sl)      ((sl)->threadid = 0, (sl)->l = (sl)->c = 0, 0)
#define DESTROY_LOCK(sl)      (0)
#define ACQUIRE_LOCK(sl)      g_dl::win32_acquire_lock(sl)
#define RELEASE_LOCK(sl)      g_dl::win32_release_lock(sl)
#define TRY_LOCK(sl)          g_dl::win32_try_lock(sl)
#define SPINS_PER_YIELD       63
...
#define ACQUIRE_MALLOC_GLOBAL_LOCK()  ACQUIRE_LOCK(&g_dl::malloc_global_mutex);
#endif
#ifndef RELEASE_MALLOC_GLOBAL_LOCK
#define RELEASE_MALLOC_GLOBAL_LOCK()  RELEASE_LOCK(&g_dl::malloc_global_mutex);
#endif
#else  /* USE_LOCKS */
...
#define MCHUNK_SIZE         (sizeof(g_dl::mchunk))
...
#define mem2chunk(mem)      ((g_dl::mchunkptr)((char*)(mem) - TWO_SIZE_T_SIZES))
/* chunk associated with aligned address A */
#define align_as_chunk(A)   (g_dl::mchunkptr)((A) + align_offset(chunk2mem(A)))
...
#define chunk_plus_offset(p, s)  ((g_dl::mchunkptr)(((char*)(p)) + (s)))
#define chunk_minus_offset(p, s) ((g_dl::mchunkptr)(((char*)(p)) - (s)))

/* Ptr to next or previous physical malloc_chunk. */
#define next_chunk(p) ((g_dl::mchunkptr)( ((char*)(p)) + ((p)->head & ~FLAG_BITS)))
#define prev_chunk(p) ((g_dl::mchunkptr)( ((char*)(p)) - ((p)->prev_foot) ))

/* extract next chunk's pinuse bit */
#define next_pinuse(p)  ((next_chunk(p)->head) & PINUSE_BIT)

/* Get/set size at footer */
#define get_foot(p, s)  (((g_dl::mchunkptr)((char*)(p) + (s)))->prev_foot)
#define set_foot(p, s)  (((g_dl::mchunkptr)((char*)(p) + (s)))->prev_foot = (s))
...
#define ok_magic(M)      ((M)->magic == g_dl::mparams.magic)
...
#define mark_inuse_foot(M,p,s)\
  (((g_dl::mchunkptr)((char*)(p) + (s)))->prev_foot = ((size_t)(M) ^ g_dl::mparams.magic))

#define get_mstate_for(p)\
  ((g_dl::mstate)(((g_dl::mchunkptr)((char*)(p) +\
    (chunksize(p))))->prev_foot ^ g_dl::mparams.magic))

#define set_inuse(M,p,s)\
  ((p)->head = (((p)->head & PINUSE_BIT)|s|CINUSE_BIT),\
  (((g_dl::mchunkptr)(((char*)(p)) + (s)))->head |= PINUSE_BIT), \
